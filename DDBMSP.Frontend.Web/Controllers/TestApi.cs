...
namespace DDBMSP.Frontend.Web.Controllers.APIs
{
    ...
    public class TestActorSystemController : Controller
    {
        ...
        private List<string> LasttNameList { get; set; } = new List<string>
        {
            "Karenza",
            "Méabh",
            "Gae",
        ...
        private List<string> SurNameList { get; set; } = new List<string>
        {
            "Rhode",
            "Ofelia",
            "Rodrigo",
        ...
        private List<string> Contents { get; set; } = new List<string>
        {
        ...
        private List<string> TitleList { get; set; } = new List<string>
        {
        ...
        private List<string> ExcerptsList { get; set; } = new List<string>
        {
        ...
        private List<string> ImagesList { get; set; } = new List<string>
        {
            "https://static.businessnews.com.au/sites/default/files/styles/medium_906x604/public/articles-2017-11/Cars%20Parked%20on%20Side%20of%20Road.jpg?itok=9HBzF0n1",
        ...
        private List<string> UniversityList { get; set; } = new List<string>
        {
        ...
        private List<string> ProfileList { get; set; } = new List<string>
        {
        ...
        {
            "space", "opera", "actor-system", "computing", "computer-science", "art", "nature", "star-wars", "mozart", "classic", "bright"
        };
        ...
        public async Task<IActionResult> CreateUser()
        {
            ...
            state.Exists = true;
            state.Id = id;
            await friend.SetState(state);
            return Created($"/test/author/{id}", id);
        }
